...
if (isset($_SESSION['instructor'])) {
    ...
    if (isset($_POST['MakeQuiz'])) {
        $_SESSION['quiz_course_id'] = $_POST['crs_id'];
    }
...
//convert date format
    ...
    $_SESSION['excel_sheet'] = $quizVal->getSheet();
            ...
            <div class="form-group" style="background-color: #fff; margin: 90px 70px; border-radius: 10px; padding-bottom: 50px;">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <label for="title">
                        ...
                        <input type="text" name="quiz_title" style="width: 400px; margin-left: 55px;" value="<?php
                        if (isset($_POST['quiz_title'])) {
                            echo $_POST['quiz_title'];
                        }
                        ?>">
                    ...
                    <label>
                        ...
                        <br>
                        <input type="textarea" name="quiz_describtion" style="margin-left: 80px; width: 1000px; height: 100px; margin-top: 10px;" value="<?php
                        if (isset($_POST['quiz_describtion'])) {
                            echo $_POST['quiz_describtion'];
                        }
                        ?>">
                    ...
                    <label for="quizDate">
                        ...
                        Quiz Date:
                        <input type="date" name="quizDate" style="margin-left: 160px;"  value="<?php
                            if (isset($_POST['quizDate'])) {
                                $date = date_create($_POST['quizDate']);
