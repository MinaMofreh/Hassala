                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $courses[$i]->description; ?></td><td>
                                            ...
                                            for ($m = 0; $m < count($courses[$i]->quizes); $m++) {
                                                ?><form method="POST" action="do_quiz.php"><button class="btn btn-primary" type="submit" id ="start_quiz_<?php echo $courses[$i]->quizes[$m]->id; ?>" name ="start_quiz" value = "">Start Quiz</button><br><br>
