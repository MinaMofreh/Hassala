...
if (isset($_SESSION['instructor'])) {
        ...
        if ($validate_error_counter == 0) {
            ...
            if (isset($_FILES['profile_photo']) && !empty($_FILES['profile_photo'])) {
                ...
                if ($validate->validate_image($file_name, $file_size)) {
                    ...
                    $image_path = $instructor->set_profilePic($extension, $file_temp);
                    echo $image_path;
            ...
            if (!empty($_POST['username']) || !empty($_POST['password']) || !empty($_POST['profile_photo']))
                $instructor->EditProfile($_SESSION['instructor_id'], $_POST['username'], $_POST['password']);
    ...
    <html lang="en">
        <head>
            ...
            <link rel="stylesheet" type="text/css" href="<?php echo $css; ?>eyad_css/edit_instructor_profile_styleSheet.css">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-md-12 lead">
                                            <h2 style="color: #337ab7; font-family: 'Josefin Sans', sans-serif; 
                                                margin-left: 25px;">Edit user profile</h2>
                                            <hr>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4 text-center">
                                            <div class="img-circle avatar avatar-original center-block" style="background-size:cover;background-image:url(<?php echo $_SESSION['profile_photo']; ?>png)"></div>
                                            <br> 
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="username" placeholder="<?php echo $instructor->get_username(); ?>">
